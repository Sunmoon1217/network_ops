...
from ops.savers.lb import LBSnatSaver
from ops.savers.registry import get_savers_for_config
from ops.savers.routing import VrfSaver
...
def test_signal_parses_then_dispatches_to_savers(monkeypatch):
    ...
    """
    raw = "sysname E2E\nvlan 10\nvlan 20\n"
    monkeypatch.setattr("ops.config_repo.get_config", lambda hostname, commit=None: raw)
