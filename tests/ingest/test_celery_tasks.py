...
历史缺陷：``apps/ingest/tasks.py`` 三个阶段任务的 except 只写 ``_update_stage_status``
...
from ingest.tasks import run_collection_stage, run_parsing_stage, run_storage_stage
...
def test_each_saver_only_receives_its_own_keys():
    ...
    """
    from ingest.savers.registry import all_savers, build_saver_payloads
