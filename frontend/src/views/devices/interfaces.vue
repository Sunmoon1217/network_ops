...
<template>
  <PageLayout title="接口管理">
    ...
    <div class="table-wrapper">
      <DataTable :table-key="TABLE_KEYS.deviceInterfaces" :data="interfaces" :loading="loading">
        <DataColumn prop="device_hostname" label="设备" :width="150" sortable />
        <DataColumn prop="interface" label="接口" :width="140" sortable />
        ...
        <DataColumn prop="subnet_mask" label="子网掩码" :width="130" />
        ...
        <DataColumn column-key="operation" label="操作" :width="80" fixed="right" align="center">
          <template #default="{ row }">
