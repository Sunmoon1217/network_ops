...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        from ops.access_stream import GROUP, STREAM, beat, consumer_name, ensure_group, get_redis
    ...
    def _process(self, client, message_id, fields) -> None:
        from ops.access_stream import GROUP, STREAM, handle_message
